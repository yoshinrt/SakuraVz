...
//	{F_WORDSREFERENCE,		LTEXT("WordReference"),			{VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_EMPTY,	NULL}, //単語リファレンス
	...
	{F_COPYPASTE,				LTEXT("CopyPaste"),					{VT_I4,    VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_EMPTY,	NULL}, //貼り付け(スタックPOPなし)
	...
	{F_REPLACE_DIALOG,			LTEXT("ReplaceDialog"),		{VT_I4,    VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_EMPTY,	NULL}, //置換(置換ダイアログ)
...
MacroFuncInfo CSMacroMgr::m_MacroFuncInfoArr[] = 
{
	...
	{F_GetScreenTop,			L"GetScreenTop",			{VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_I4,		NULL }, //画面上端行 (Layout)
	{F_GetScreenLeft,			L"GetScreenLeft",			{VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_I4,		NULL }, //画面左端桁 (Layout)
	...
	{F_MoveScreen,				L"MoveScreen",				{VT_I4,    VT_I4,    VT_EMPTY, VT_EMPTY},	VT_I4,		NULL}, // Layout 座標にスクロール移動
