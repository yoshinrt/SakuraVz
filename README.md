...
|折返し設定|[Sakura本家 v2.4.2.6109](https://github.com/sakura-editor/sakura/tree/7eb997a00e73d2cbdd071d226694c0b55f8925bf)|SakuraVz (非高速モード)|SakuraVz (高速モード)|
|--------|---:|---:|---:|
|折返さない  |42.6|25.4|6.3|
|右端で折返す|52.1|23.5|6.3<br>(強制的に折返さない)|
