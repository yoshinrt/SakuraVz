...
400MB, 1000万行のファイルオープンに要する時間は以下のとおりです．(使用 PC: AMD A8-7670K (4スレッド)  Mem:8GB)

|        |[Sakura本家](https://github.com/sakura-editor/sakura/tree/29aff6839abec9289b1568feebfabc9223c986f0)|SakuraVz (非高速モード)|SakuraVz (高速モード)|
|--------|---:|---:|---:|
|時間(秒)|32.2|26.9|5.5|
